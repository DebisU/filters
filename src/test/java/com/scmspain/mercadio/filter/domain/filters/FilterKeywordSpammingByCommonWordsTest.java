...
public class FilterKeywordSpammingByCommonWordsTest {
    ...
    private static String getAllPrepositionsAsString() {
        return "a ,  ante ,  bajo ,  cabe ,  con ,  contra ,  de ,  desde ,  en ,  entre ,  hacia ,  hasta ,"
                + "  para ,  por ,  según ,  segun ,  sin ,  so ,  sobre ,  tras";
    }
    ...
    private static String getKeyWordSpamWithoutPrepositions() {
        return "apple iphone 4 4s 5 5c 5s 6 plus ipad ipod air macbook pro\n"
                ...
                + "sobremesa bq wii nintendo canon nikon 6s \\nmovil mobil chino libre libres chinos"
                + " comprar barato baratos smarphone smarfone\n Smartphone dualsim duales 0 4.7 4 4.0"
                + " celular moviles celulares bq tablet pulgadas\n \" 5.7\" 5.5\" 4.7\" 4.5\" 5\" mobile"
                + " movile phone kayac cayak cayac canoa embarcacion\n zodiak zodiac neumatica barca surf "
